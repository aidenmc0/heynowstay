export const contentData = {
    ...
    highlights: [
      {
        id: 1,
        title: "Quiet Nights",
        desc: "No city lights, just fireflies.",
        img: "/assets/image/Highlight/image1.jpg",
      },
      {
        id: 2,
        title: "Camping",
        desc: "Camping under stars with fire.",
        img: "/assets/image/Highlight/image2.jpg",
      },
      {
        id: 3,
        title: "Beautiful Nature",
        desc: "Forest trails and mountain views.",
  ...
  th: {
    ...
    story: {
      ...
      text1:
        "ใจกลางของเชียงดาว ที่ภูเขาไกวกเมฆท้อฟ้า เราพบชิ้ทิดสวยงามที่ฟังเบียบเบียบ หากระว่า มันส่งเสียงไม่ใช่ แต่ขอให้จำเสียง มันดังมากขึ้น และยาวนว่าจะไปไปนอนได้",
      text2:
        "สร้างขึ้นด้วยมือท้องถิก ใช้ไม้สักทองและดินเหนียว โฮมสเตย์ของเราให้เกียบกับจังหวะของธรรมชาติ ที่นี่ ไม่ใช้นาฬิกา เช้าวันขึ้นด้วยเสียงนกของและกลิ่นกาแฟร็ชเสียงป่า เราชวนคุณมาตัดการตัดกับอุดรูรวของคุณเอง",
    },
    ...
    highlights: [
      {
        id: 1,
        title: "ค่ำคืนเงียบสงบ",
        desc: "ไม่มีแสงไฟเมือง มีเพียงหิ่งหิ่ง",
        img: "/assets/image/Highlight/image1.jpg",
      },
      {
        id: 2,
        title: "แคมปปิ้ง",
        desc: "กองเต็นท์พักค่ายใต้ดาวตะเคียงไฟ",
        img: "/assets/image/Highlight/image2.jpg",
      },
      {
        id: 3,
        title: "ธรรมชาติอันงดงาม",
        desc: "เส้นทางเดินในป่าและวิวภูเขา",
        img: "/assets/image/Highlight/image3.jpg",
      },
      {
        id: 4,
        title: "รับสัตวเลี้ยง",
        desc: "พาเพื่อนรักของคุณมาด้วย",
        img: "/assets/image/Highlight/image4.jpg",
      },
    ],
    testimonials: [
